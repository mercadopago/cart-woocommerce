...
> Note: Luhn (checksum) validation is **not** available in this flow — `cardForm()` does not honour `enableLuhnValidation`. This is a confirmed SDK limitation, tracked separately.
