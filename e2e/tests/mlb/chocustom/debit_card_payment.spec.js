...
test('test successful payment as guest with elo', async ({page}) => {
...
test('test pending payment as guest with elo', async ({page}) => {
...
test('test with filled card but other fields empty - elo', async ({page}) => {
...
test('test payment rejected by other reasons - elo', async ({page}) => {
