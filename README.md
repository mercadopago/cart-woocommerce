<p align="center"><a href="https://www.mercadopago.com/">    <img src="https://http2.mlstatic.com/ui/navigation/5.3.7/mercadopago/logo__large@2x.png" height="80" width="auto" alt="MercadoPago">
</a></p>
...
| :------------  | :------------- | :--------------- |
| **Important security update and deactivation!** <br/> <br/> In October, 2022, versions that are incompatible with our new method of sending access tokens via header (prior to 4.5.0 - Release: 10/26/2020) will be deactivated. This measure is to ensure more security to your transactions. Therefore, it is extremely important that your store is up to date with the latest version of our Plugin. | **Importante desactivación y actualización de seguridad!** <br/> <br/> En octubre del 2022, habrá una desactivación de las versiones que no son compatibles con el nuevo método de envío de access token via header (prior to 4.5.0 - Release: 26/10/2020). Esta es una medida que tiene como objetivo garantizar más seguridad en tus transacciones. Por eso, es de extrema importancia que tu tienda esté actualizada con la última versión de nuestro Plugin. | **Deprecação e atualização de segurança importante!** <br/> <br/> Em Outubro de 2022, haverá a deprecação de versões que não são compatíveis com o novo método de envio de access token via header (prior to 4.5.0 - Release: 26/10/2020). Esta é uma medida que visa garantir mais segurança em suas transações. Por isso, é de extrema importância que sua loja esteja atualizada com a última versão do nosso Plugin.
