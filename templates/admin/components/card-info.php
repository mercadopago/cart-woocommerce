...
<div class="mp-card-info">
    ...
    <div class="mp-card-body-payments <?= esc_html($settings['value']['size_card']); ?>">
        ...
        <div>
            ...
            <a class="mp-button-payments-a" target="<?= esc_html($settings['value']['target']); ?>" href="<?= esc_html($settings['value']['button_url']); ?>">
                <button type="button" class="mp-button-payments"><?= esc_html($settings['value']['button_text']); ?></button>
            </a>
        </div>
    </div>
</div>
